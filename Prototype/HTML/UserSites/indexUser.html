...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                <div>
                                    <strong>TestWorker</strong> <span class="pull-right text-muted">
										<em>Gestern</em>
									</span>
                                </div>
                                <div>Hallo bei Ihrer Reklamation haben Sie folgendes vergessen.....</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                ...
                                <div>Hallo Sie hätten einen Liferschaden erfasst .....</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    <strong>TestWorker</strong> <span class="pull-right text-muted">
										<em>Heute um 14:35:23 Uhr</em>
									</span>
                                </div>
                                <div>Bitte um rasche Antwort ...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a class="text-center" href="messagesUser.html"> <strong>Alle Nachrichten anzeigen</strong> <i class="fa fa-angle-right"></i>
                            </a>
                        </li>
                    </ul>
                    <!-- /.dropdown-messages -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-tasks">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a class="text-center" href="messagesUser.html"> <strong>Alle Reklamationen ansehen</strong> <i class="fa fa-angle-right"></i>
                            </a>
                        </li>
                    </ul>
                    <!-- /.dropdown-tasks -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="indexUser.html"><i class="fa fa-dashboard fa-fw"></i>
								Dashboard</a></li>
                        <li><a href="tasksUser.html"><i class="fa fa-plus fa-fw"></i>
								Neue Reklamation</a></li>
                        <li><a href="messagesUser.html"><i class="fa fa-envelope fa-fw"></i>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" id="notification-cht">1</div>
                                    <div>Neuer Kommentar!</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="chat-panel panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu slidedown">
                            <li>
                                <a href="#" id="refresh"> <i class="fa fa-refresh fa-fw"></i> Aktualisieren
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul class="chat" id="chat-div">
                        <li class="left clearfix"><span class="chat-img pull-left">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">TestUser</strong> <small class="pull-right text-muted"> <i class="fa fa-clock-o fa-fw"></i> Vor 15 Minuten
										</small>
                                </div>
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <small class=" text-muted"> <i
										...
										></i> Vor 14 Minuten
										</small> <strong class="pull-right primary-font">TestWorker</strong>
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                </p>
                            </div>
                        ...
                        <li class="left clearfix"><span class="chat-img pull-left">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
                                    <strong class="primary-font">TestUser</strong> <small class="pull-right text-muted"> <i class="fa fa-clock-o fa-fw"></i> Vor 13 Minuten
										</small>
                                </div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                                </p>
                ...
                <div class="panel-footer">
                    <div class="input-group">
                        <input id="btn-input" type="text" class="form-control input-sm" placeholder="Nachricht hier eingeben..." /> <span class="input-group-btn">
    ...
    <script src="../../JavaScript/IndexFiles/raphael.min.js"></script>
    <script src="../../JavaScript/IndexFiles/morris.min.js"></script>
    <script src="../../JavaScript/IndexFiles/morris-data.js"></script>
